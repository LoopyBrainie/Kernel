...
**Rounds**: R53-R62 命名迁移立法总账 (R53-R60 命名迁移 + R61 syscall 11-15 增补 + R62 收官 D174 mmap 后缀漏网 + GOV.5 三件套纪律)。R63 同步 SPEC.md 扫描面 + boot banner SSOT (D175 立法)。R64 立法 AUDIT_LINE_FILTER 行内化 + 行内豁免标记机制 + D-ref 校验 (D176 治理立法, governance class 2, 与命名正交)。
