...
AUDIT_LINE_FILTER='grep -vE "\[OBSOLETED|rename from|审计档案|应为|应改|诚实性|命名诚实性|migration|原文|R4[0-6] 勘误|R4[0-6] 修正|R36 错算|R36 D80 原案|R37 D128|R45 默认|R45 裁定|R45 原案|D151 R46|R46 勘误|R46 修正|R46 落地|R46 反杜撰|R46 ledger|R46 双结构|R46 临时|R46 勘误后|R47 勘误|R47 增补|R47 撤销|R47 立法|R47 ctypes|R47 后回到|R48 勘误|R51 D153|R51-F1|R51-F2|R51-F4|R51-F5|R51-M2|R51-M3|R51-M4|R51-M5|R51-M6|R51-M7|R52 D16[123]|R52 立法|R52 收口|R53 D16[4567]|R53 收口|D165 反向锚|R30/R31|R31 历史|R31 spec|R55 收口|R58 阻塞|R59 D171|R59 收口|R59 命名|R59 13|D171 立法|D172 历史|D172 围栏|D172 元规则|R60 收口|R58 补执行|R58 ✅|撤销 cosmo_kernel|crate 名|crate 命名空间|Q69 豁免|R61 syscall 11-15|R61 增补|接口层剥离|R61 收口|P[1-3]-[0-9]+ 修复|P[1-3]-[0-9]+ 勘误|P[1-3]-[0-9]+ 同款|P[1-3]-[0-9]+ \(R47|Step 0 trap 防御|不分配 Vec|原 char buf|原 basal_do_user_fault_fixup|勘误后|勘误前|D153 决策|Dispatcher 命名锚定|重命名裁决|新增禁词|传染面清单|D160 (配套|矩阵)|16 号文.*rpc_unit_t.*(配套|未立法|禁用依据|R50 立法)|R62 D174|R62 立法|R62 收官|R62 命名补漏|R62 后缀|R62 GOV.5|R62 mmap_命名补漏|R62 状态头|D174 mmap 命名|D174 GOV.5|D174 双目标|D174 后缀|收官同步状态头|状态头断档|状态头同步|GOV.5 检查单|R62 自身示范|R62 传染面|R62 后缀形态|R62 双目标|命名法第 19|19 条禁词|R62 立法 D174|R62-D174|D174 后缀命名漏网补漏|R63 D175|R63 立法|R63 收官|R63 收口|R63 自身示范|R63 补执行|R63-FINAL|R63 SPEC|R63 banner|R63 扫描面|R63 自身示范|R63 三件套→四件套|R63 四件套|R63 boot banner|R63 COSMO|D175 SPEC|D175 banner|D175 boot banner|D175 四件套|D175 GOV.5|D175 自身示范|D175 扫描面|D175 收官|D175 收口|D175 自身示范|D175 立法|D175 boot banner SSOT|COSMO BOOT OK|NEURA BOOT OK|boot banner SSOT|GOV.5 四件套|GOV.5 自身示范|GOV.5 扫描面|四件套|状态头四件套|扫描面立法|SPEC.md 扫描面|SPEC 扫描面|R63 收官同步状态头|R63 收官同步)"'
